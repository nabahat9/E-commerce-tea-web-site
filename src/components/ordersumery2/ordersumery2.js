...
function Ordersumery() {
    return(
        <div className='bg-[#F4F4F4]  ml-16 my-12'>
        ...
        <button className='font-MontserratMeduim text-16 px-16 mb-6 leading-20 bg-[#282828] tracking-tighter mx-8 text-center text-white '>
        <p className='px-16 mx-10 my-3'>GO TO PAYMENT</p></button>
        </div>
        </div>
    )};
